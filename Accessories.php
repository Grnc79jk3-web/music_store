...
<head>
    ...
    <title>JT Music Store - Accessories</title>
    ...
    <section class="products">
        <div class="container">
            <div class="product-grid">
                ...
                $accessories_sql = "SELECT * FROM Products WHERE CategoryID = 3 AND StockLevel > 0";
                $accessories_result = $conn->query($accessories_sql);

                if ($accessories_result->num_rows > 0) {
                    while($product = $accessories_result->fetch_assoc()) {
