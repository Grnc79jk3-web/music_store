...
<head>
    ...
    <title>JT Music Store - Audio Equipment</title>
    ...
    <section class="products">
        <div class="container">
            <div class="product-grid">
                ...
                $audio_equipment_sql = "SELECT * FROM Products WHERE CategoryID = 4 AND StockLevel > 0";
                $audio_equipment_result = $conn->query($audio_equipment_sql);

                if ($audio_equipment_result->num_rows > 0) {
                    while($product = $audio_equipment_result->fetch_assoc()) {
