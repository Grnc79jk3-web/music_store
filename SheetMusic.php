...
<head>
    ...
    <title>JT Music Store - Sheet Music</title>
    ...
    <section class="products">
        <div class="container">
            <div class="product-grid">
                ...
                $sheet_music_sql = "SELECT * FROM Products WHERE CategoryID = 2 AND StockLevel > 0";
                $sheet_music_result = $conn->query($sheet_music_sql);

                if ($sheet_music_result->num_rows > 0) {
                    while($product = $sheet_music_result->fetch_assoc()) {
